<template>
    <div class="common-layout" style="width: 100%;height: 100%;">
        <el-container style="width: 100%;height: 100%;">
            <el-aside width="100">
                <el-menu style="height: 100%;border:0;" :unique-opened="true" active-text-color="#fff"
                    ...
                    <el-menu-item index="/sms/" style="height: 80px;">
                        <el-icon> <img v-if="isCollapse" style="display: block; width: 50px;height:50px;" src="../../public/image/photo_2023-06-10_19-28-21.ico" alt=""></el-icon>
                        <template #title><img v-if="!isCollapse" style="display: block; width: 100px;height:100px;" src="../../public/image/photo_2023-06-10_19-28-21.jpg" alt=""></template>
                    </el-menu-item>
                    <el-sub-menu index="1">
                        <template #title>
                            <el-icon>
                    ...
                    </el-sub-menu> <el-sub-menu index="4">
                        <template #title>
                            <el-icon>
                                <Coin />
                            </el-icon>
            ...
            <el-container>
                <el-header
                    style="display: flex;justify-content: space-between;align-items: center;background-color:#1A1C26 ;color: #ccc;">
                    <div
                        style="height: 100%;display: flex;width: 40px;justify-content: center;align-items: center;font-size: 25px;">
